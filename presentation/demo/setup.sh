...
EOF
# --- agent tooling (composable, by label) ----------------------------------
...
agent(name = "modernizer", harness = "//tools/harness:claude_code", model = "//tools/models:sonnet")
EOF
...
github_import(
    ...
    transforms = [
        ...
        # generative - a coding agent modernizes the landed code:
        agent_transform(
